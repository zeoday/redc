export const i18n = {
  zh: {
    ...
    cases: '预定义场景',
    searchCases: '搜索场景...', showingResults: '显示',
    ...
    saving: '保存中...', saved: '已保存', saveProxy: '保存代理配置', proxyHint: '配置后将用于 Terraform 的网络请求',
    ...
    composeTopology: '拓扑视图', composeSvcCount: '个服务', composeDepsCount: '条依赖',
    composeDeploying: '正在部署编排...', composeDestroying: '正在销毁编排...',
    composeUpDone: '编排部署完成', composeDownDone: '编排销毁完成',
    composeUpFailed: '编排部署失败', composeDownFailed: '编排销毁失败',
    composeDestroyConfirmTitle: '确认销毁编排', composeDestroyConfirmDesc: '此操作将销毁所有编排服务和关联资源，不可撤销',
    composeDestroyConfirm: '确认销毁', dismiss: '关闭',
    composeSourceTemplate: '从模板选择', composeSourceFile: '自定义文件路径',
    composeAdvanced: '高级选项',
    composeStatusRunning: '运行中', composeStatusStopped: '已停止', composeStatusNotDeployed: '未部署', composeStatusCreated: '已创建',
    composeGuideHint: '选择 Compose 模板或指定文件路径开始编排',
    serviceStatus: '状态',
    ...
    validateTemplate: '语法检查', validating: '验证中...', validatePassed: '验证通过', validateFailed: '验证失败',
    validatePassedMsg: '模板语法和参数配置正确，可以正常使用。', errors: '错误', warnings: '警告',
    ...
    spotMonitor: 'Spot 实例监控', spotMonitorDesc: '定期检测运行中的抢占式实例是否被云厂商回收，回收时发送通知',
    spotAutoRecover: 'Spot 自动恢复', spotAutoRecoverDesc: '检测到实例被回收时自动执行 terraform apply 补齐缺失实例',
    spotRecovering: '🔄 正在自动恢复...', spotRecovered: '✅ 抢占式实例已自动恢复', spotRecoverFailed: '⚠️ 自动恢复失败', spotRecoverFailedHint: '可能暂无库存，下次扫描将重试',
    webhookNotification: 'Webhook 通知', webhookNotificationDesc: '场景状态变化时推送消息到 Slack/钉钉/飞书/Discord/企业微信',
    webhookEnabled: '启用 Webhook 通知', webhookSlack: 'Slack Webhook URL', webhookDingtalk: '钉钉 Webhook URL',
    webhookDingtalkSecret: '钉钉签名密钥', webhookFeishu: '飞书 Webhook URL', webhookFeishuSecret: '飞书签名密钥',
    webhookDiscord: 'Discord Webhook URL', webhookWecom: '企业微信 Webhook URL',
    webhookSave: '保存 Webhook 配置', webhookSaveSuccess: 'Webhook 配置保存成功', webhookSaveFailed: 'Webhook 配置保存失败',
    webhookTest: '测试', webhookTestSuccess: '测试消息发送成功', webhookTestFailed: '测试消息发送失败',
    webhookSecretHint: '可选，用于签名验证', webhookUrlHint: '留空则不推送到该平台',
    tags: '标签', addTag: '添加标签', tagPlaceholder: '输入标签名', tagFilterAll: '全部', tagManage: '管理标签', noTags: '无标签', tagSaved: '标签已保存',
    runningTime: '运行时间',
    ...
    calculating: '计算中...', costEstimateError: '成本估算错误',
    ...
    aiMaxToolRounds: 'Agent 最大工具调用轮次', aiMaxToolRoundsHint: 'Agent / 开源部署模式下 AI 可调用工具的最大轮次，0 为使用默认值',
   ...
   // SSH Operations
    ...
    execUserdata: '命令片段', noTemplates: '暂无可用模板', goToTemplateRepo: '前往模板仓库 →',
    scriptPreview: '脚本预览', uploading: '上传中...', uploadAndExec: '上传并执行',
    ...
    confirmCancelTaskMessage: '确定要取消定时任务',
    // AI Features
    ...
    spotInstance: '抢占式',
    spotTerminated: '已回收',
    spotTerminatedTitle: '⚠️ 抢占式实例已被云厂商回收',
    terminated: '已回收',
    ...
    // AI Chat
    aiChat: 'AI 对话',
    aiChatFreeChat: '自由对话', aiChatAgent: 'Agent 助手', aiChatDeploy: '开源部署', aiChatErrorAnalysis: '报错分析', aiChatGenTemplate: '生成模板', aiChatRecommend: '推荐场景', aiChatCostOpt: '成本优化',
    ...
    aiChatWelcomeAgent: '你好！我是 RedC Agent 助手，你可以用自然语言操作 RedC。例如：「帮我列出所有运行中的场景」「停止场景 xxx」「在场景 xxx 上执行 whoami 命令」',
    aiChatWelcomeDeploy: '你好！我是开源部署助手 🚀 告诉我你想部署的项目和需求，我会自动完成从创建云服务器到安装部署的全流程。\n\n例如：\n• 「帮我在阿里云上部署一个 nginx，监听 8080 端口」\n• 「部署 https://github.com/xxx/yyy 到一台 AWS EC2 上」\n• 「帮我装一个 redis 服务器」',
    ...
    aiChatWelcomeErrorAnalysis: '你好！我是 RedC 报错分析专家。请粘贴部署失败的错误信息，我会帮你分析原因并提供解决方案。我了解 Terraform 语法、各云厂商 API 错误码以及 RedC 模板结构。',
    aiChatCopied: '已复制', aiChatSaveTemplate: '保存模板', aiChatCopyContent: '复制内容',
    aiChatStreaming: 'AI 思考中...', agentProcessing: 'Agent 执行中...', agentViewResult: '查看结果',
  ...
  en: {
    ...
    searchCases: 'Search scenarios...', showingResults: 'Showing',
    ...
    saving: 'Saving...', saved: 'Saved', saveProxy: 'Save Proxy Config', proxyHint: 'Used for Terraform network requests',
    ...
    composeTopology: 'Topology View', composeSvcCount: 'services', composeDepsCount: 'dependencies',
    composeDeploying: 'Deploying...', composeDestroying: 'Destroying...',
    composeUpDone: 'Compose deployment completed', composeDownDone: 'Compose teardown completed',
    composeUpFailed: 'Compose deployment failed', composeDownFailed: 'Compose teardown failed',
    composeDestroyConfirmTitle: 'Confirm Destroy', composeDestroyConfirmDesc: 'This will destroy all compose services and associated resources. This action cannot be undone.',
    composeDestroyConfirm: 'Destroy', dismiss: 'Dismiss',
    composeSourceTemplate: 'From Template', composeSourceFile: 'Custom File Path',
    composeAdvanced: 'Advanced Options',
    composeStatusRunning: 'Running', composeStatusStopped: 'Stopped', composeStatusNotDeployed: 'Not Deployed', composeStatusCreated: 'Created',
    composeGuideHint: 'Select a Compose template or specify a file path to start',
    ...
    templateNamePlaceholder: 'e.g. my-template or myteam/ecs',
    ...
    validateTemplate: 'Validate', validatePassed: 'Validation Passed', validateFailed: 'Validation Failed',
    validatePassedMsg: 'Template syntax and parameter configuration are correct.', errors: 'error', warnings: 'warning',
    ...
    spotMonitor: 'Spot Instance Monitor', spotMonitorDesc: 'Periodically check if running spot instances have been reclaimed by the cloud provider',
    spotAutoRecover: 'Spot Auto-Recovery', spotAutoRecoverDesc: 'Automatically run terraform apply to replenish terminated spot instances',
    spotRecovering: '🔄 Auto-recovering...', spotRecovered: '✅ Spot instance recovered', spotRecoverFailed: '⚠️ Auto-recovery failed', spotRecoverFailedHint: 'No available inventory, will retry on next scan',
    webhookNotification: 'Webhook Notification', webhookNotificationDesc: 'Push messages to Slack/DingTalk/Feishu/Discord/WeCom when scene status changes',
    webhookEnabled: 'Enable Webhook Notification', webhookSlack: 'Slack Webhook URL', webhookDingtalk: 'DingTalk Webhook URL',
    webhookDingtalkSecret: 'DingTalk Signing Secret', webhookFeishu: 'Feishu Webhook URL', webhookFeishuSecret: 'Feishu Signing Secret',
    webhookDiscord: 'Discord Webhook URL', webhookWecom: 'WeCom Webhook URL',
    webhookSave: 'Save Webhook Config', webhookSaveSuccess: 'Webhook config saved', webhookSaveFailed: 'Failed to save webhook config',
    webhookTest: 'Test', webhookTestSuccess: 'Test message sent successfully', webhookTestFailed: 'Failed to send test message',
    webhookSecretHint: 'Optional, for signature verification', webhookUrlHint: 'Leave empty to skip this platform',
    tags: 'Tags', addTag: 'Add tag', tagPlaceholder: 'Enter tag name', tagFilterAll: 'All', tagManage: 'Manage tags', noTags: 'No tags', tagSaved: 'Tag saved',
    ...
    calculating: 'Calculating...', costEstimateError: 'Cost Estimation Error',
    ...
    aiMaxToolRounds: 'Agent Max Tool Rounds', aiMaxToolRoundsHint: 'Max tool call rounds for Agent / Deploy mode. 0 uses default value.',
    ...
    goToTemplateRepo: 'Go to Template Registry →',
    ...
    resourceType: 'Resource Type', count: 'Count', keyInfo: 'Key Info',
    ...
    confirmCancelTaskMessage: 'Are you sure you want to cancel scheduled task',
    // AI Features
    ...
    spotTerminated: 'Reclaimed',
    spotTerminatedTitle: '⚠️ Spot instance reclaimed by provider',
    ...
    baseTemplate: 'Base Template', supportedProviders: 'Supported Providers',
    ...
    // AI Chat
    aiChat: 'AI Chat',
    aiChatFreeChat: 'Free Chat', aiChatAgent: 'Agent', aiChatDeploy: 'Deploy', aiChatErrorAnalysis: 'Error Analysis', aiChatGenTemplate: 'Generate Template', aiChatRecommend: 'Recommend Scenario', aiChatCostOpt: 'Cost Optimization',
    ...
    aiChatWelcomeAgent: 'Hello! I\'m the RedC Agent. You can control RedC with natural language. Try: "List all running scenarios", "Stop scenario xxx", "Execute whoami on scenario xxx".',
    aiChatWelcomeDeploy: 'Hello! I\'m the Deploy Assistant 🚀 Tell me what project you want to deploy and I\'ll handle everything — from creating a cloud server to installing the software.\n\nExamples:\n• "Deploy nginx on Alibaba Cloud, listening on port 8080"\n• "Deploy https://github.com/xxx/yyy on an AWS EC2"\n• "Set up a Redis server for me"',
    ...
    aiChatWelcomeErrorAnalysis: 'Hello! I\'m the RedC error analysis expert. Paste your deployment error message and I\'ll analyze the root cause and provide solutions. I understand Terraform syntax, cloud provider API error codes, and RedC template structures.',
    aiChatCopied: 'Copied', aiChatSaveTemplate: 'Save Template', aiChatCopyContent: 'Copy Content',
    aiChatStreaming: 'AI is thinking...', agentProcessing: 'Agent is working...', agentViewResult: 'View result',
