export const i18n = {
  zh: {
    ...
    validatePassedMsg: '模板语法和参数配置正确，可以正常使用。', errors: '个错误', warnings: '个警告',
   ...
   // SSH Operations
    ...
    // AI Chat
    aiChat: 'AI 对话',
    aiChatFreeChat: '自由对话', aiChatAgent: 'Agent 助手', aiChatGenTemplate: '生成模板', aiChatRecommend: '推荐场景', aiChatCostOpt: '成本优化',
  ...
  en: {
    ...
    validateTemplate: 'Validate', validating: 'Validating...', validatePassed: 'Validation Passed', validateFailed: 'Validation Failed',
    validatePassedMsg: 'Template syntax and parameter configuration are correct.', errors: 'error(s)', warnings: 'warning(s)',
    ...
    // AI Chat
    aiChat: 'AI Chat',
    aiChatFreeChat: 'Free Chat', aiChatAgent: 'Agent', aiChatGenTemplate: 'Generate Template', aiChatRecommend: 'Recommend Scenario', aiChatCostOpt: 'Cost Optimization',
